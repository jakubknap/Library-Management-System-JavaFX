...
public class AdminMainBorderPaneController {
    ...
    private static final String MANAGE_USERS_FXML = "/pl/knap/fxml/ManageUsers.fxml";
    private static final String MANAGE_BOOKS_FXML = "/pl/knap/fxml/ManageBooks.fxml";
